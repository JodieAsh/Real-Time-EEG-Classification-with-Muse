...
import os, sys
import numpy as np
from EEGFeatureExtraction import generate_feature_vectors_from_samples_csv
...
def gen_training_matrix(directory_path, output_file, cols_to_ignore):
	...
	for x in os.listdir(directory_path):
		...
		vectors, header = generate_feature_vectors_from_samples_csv (file_path = full_file_path,
														        nsamples = 150, 
																period = 1.,
																state = state,
